							...
							<div class="row">
								<div class="col-md-6">
									...
									if(isset($_POST['category'])) {
										...
										// The category recieved is stored in the variable $cat
										$cat = $_POST['category'];
										
										// The recieved category is deleted from the database table category using the DELETE statement
										$qry = $con->query("DELETE FROM category WHERE category = '$cat'");
