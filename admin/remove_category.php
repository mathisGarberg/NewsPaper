			...
			<div class="row">
				<div class="col-xs-12 col-sm-10 col-md-10 col-sm-offset-1 col-md-offset-1">
					...
					<ul class="nav nav-tabs" role="tablist">
						...
						<li class="active"><a href="remove_category.php" role="tab" data-toggle="tab">Remove Category</a></li>
						<!-- Remove Users -->
					...
					<div class="tab-content">
						<div class="tab-pane active" id="home">
							<div class="row">
								<div class="col-md-6">
									<form name="remove_category" method="POST" action="category_removed.php">
									...
									<!-- When submit button is clicked, the selected category in the select box is transferred to category_removed -->
